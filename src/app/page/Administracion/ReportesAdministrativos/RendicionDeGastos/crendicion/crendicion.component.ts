...
export class CrendicionComponent implements OnInit {
  ...
  inicializar(){
    this.form = new FormGroup({
      ...
      'monedaRecibe': new FormControl({ value: '', disabled: false}),
      'montoRecibe': new FormControl({ value: 0, disabled: false}),
      'fechaPresenta': new FormControl({ value: new Date(), disabled: false}),
      'fechaApruebaRechaza': new FormControl({ value: new Date(), disabled: false}),
      'fechaProcesa': new FormControl({ value: new Date(), disabled: false}),
      'ideUsuProcesa': new FormControl({ value: 0, disabled: false}),
      ...
      'docuGenerado': new FormControl({ value: 0, disabled: false}),
      'fechaAceptado': new FormControl({ value: new Date(), disabled: false}),
      ...
      'fechaRevisado': new FormControl({ value: new Date(), disabled: false}),
